...
user_name = 'ginandtonicbarneystinsonhimym.seventh'
last_name = '@gmail.com'
        ...
        while True:
            ...
            try:
                ...
                while True:
                    try:
                        num = "%s" % number_name
                        browser.find_element(by=By.XPATH, value="//input[@id='display_name']").send_keys("bourbon" + num)
                        break
                    except Exception as ex:
                        print(ex)
                        time.sleep(0.1)
