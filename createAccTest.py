...
user_name = 'ginandtonicbarneystinsonhimym.best'
last_name = '@gmail.com'
...
# opts.add_extension('/Users/hungnguyen/Desktop/Desktop/test/PreSearch/1.3.1_0.crx')
# opts.add_argument('--load-extension={}'.format('/Users/hungnguyen/Desktop/Desktop/test/PreSearch/lfpfbgeoodeejmjdlfjbfjkemjlblijg/1.3.1_0'))
        ...
        while True:
            ...
            try:
                ...
                while True:
                    try:
                        num = "%s" % number_name
                        browser.find_element(by=By.XPATH, value="//input[@id='display_name']").send_keys("ginntonic" + num)
                        break
                    except Exception as ex:
                        print(ex)
                        time.sleep(0.1)
                ...
                fname = "tonic" + num_file              
                data = {"email":username, "cookie":ncookie, "code":code, "progress":"todo"}
