...
user_name = 'ginandtonicbarneystinsonhimym.svrtuan'
last_name = '@gmail.com'
    ...
    while True:
        ...
        while True:
            ...
            try:
                ...
                capmonster = HCaptchaTask("7cf6f78991bf4ae67a5b31d1440053e1")
                ...
                while True:
                    try:
                        num = "%s" % number_name
                        browser.find_element(by=By.XPATH, value="//input[@id='display_name']").send_keys("brandy" + num)
                        break
                    except Exception as ex:
                        print(ex)
                        time.sleep(0.1)
                ...
                fname = "brandy" + num_file              
                data = {"email":username, "cookie":cookies, "code":code, "progress":"todo"}
